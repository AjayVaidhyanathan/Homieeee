...
/// This is just an testing widget and not used in the final app.
const LatLng currentLocation = LatLng(48, 12);
...
class _GoogleMapsWidgetState extends State<GoogleMapsWidget> {
  static const CameraPosition _initialCameraPosition = CameraPosition(
    target: LatLng(48.42796133580664, 12.085749655962),
    zoom: 14.4746,
  );
        ...
        children: [
          GoogleMap(
              ...
              onMapCreated: (GoogleMapController controller) {
                ...
                _mapController?.setMapStyle(_mapThemes[2]['style']);
              }),
          CustomInfoWindow(
